...
@property (readonly, nonatomic, copy) NSString *sequence;
@property (readonly, nonatomic, copy) NSString *cache;
...
- (instancetype)initWithContentOfURL:(NSURL *)URL type:(M3U8MediaPlaylistType)type baseURL:(NSURL *)baseURL error:(NSError **)error;
