...
#import "ESPlayerCoordinateProtocol.h"

NS_ASSUME_NONNULL_BEGIN

@interface ESAVPlayerCoordinator : NSObject<ESPlayerCoordinateProtocol>
...
@property (nonatomic, strong, nullable) id<ESMediaModelProtocol> media;
