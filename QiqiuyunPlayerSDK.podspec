...
气球云资源播放器，支持视频、音频、PPT、文档资源文件
  ...
  # s.source           = { :git => 'https://github.com/codeages/qiqiuyun-player-ios-sdk.git', :tag => s.version.to_s }
  s.source           = { :git => '/Users/tony/Documents/work/code/qiqiuyun-player-ios-sdk', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.vendored_frameworks = 'QiqiuyunPlayerSDK/Framework/QiqiuyunPlayerSDK.framework'
