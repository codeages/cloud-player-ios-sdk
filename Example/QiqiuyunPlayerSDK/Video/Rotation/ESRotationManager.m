...
@class ESFullscreenModeViewController, ESFullscreenModeNavigationController;

NS_ASSUME_NONNULL_BEGIN
@protocol ESFullscreenModeViewControllerDelegate <NSObject>
- (UIView *)target;
...
- (void)fullscreenModeViewController:(ESFullscreenModeViewController *)vc willRotateToOrientation:(UIDeviceOrientation)orientation;
- (void)fullscreenModeViewController:(ESFullscreenModeViewController *)vc didRotateFromOrientation:(UIDeviceOrientation)orientation;
@end

@interface ESFullscreenModeViewController : UIViewController
@property (nonatomic, weak, nullable) id<ESFullscreenModeViewControllerDelegate> delegate;
@property (nonatomic) UIDeviceOrientation currentOrientation;
@property (nonatomic, readonly) BOOL isFullscreen;
@property (nonatomic) BOOL isRotated;
@end

@implementation ESFullscreenModeViewController
- (instancetype)init {
    self = [super init];
    if ( self ) {
...
@protocol ESFullscreenModeNavigationControllerDelegate <NSObject>
...
@property (nonatomic, weak, nullable) id<ESFullscreenModeNavigationControllerDelegate> ES_delegate;
@end
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    if ( [viewController isKindOfClass:ESFullscreenModeViewController.class] ) {
...
@interface ESFullscreenModeWindow : UIWindow
@property (nonatomic, strong, nullable) ESFullscreenModeNavigationController *rootViewController;
@property (nonatomic, strong, readonly) ESFullscreenModeViewController *fullscreenModeViewController;
@end

@implementation ESFullscreenModeWindow
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _fullscreenModeViewController = ESFullscreenModeViewController.new;
...
static NSNotificationName const ESRotationManagerTransitioningValueDidChangeNotification = @"ESRotationManagerTransitioningValueDidChangeNotification";


@interface ESRotationManager ()<ESFullscreenModeViewControllerDelegate, ESFullscreenModeNavigationControllerDelegate>
@property (nonatomic, strong) ESFullscreenModeWindow *window;
...
@implementation ESRotationManager {
    void(^_Nullable _completionHandler)(ESRotationManager *mgr);
}
...
- (instancetype)init {
    ...
    if (self) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            self->_window = [ESFullscreenModeWindow new];
...
- (void)rotate:(ESOrientation)orientation animated:(BOOL)animated completionHandler:(nullable void(^)(ESRotationManager *mgr))completionHandler {
