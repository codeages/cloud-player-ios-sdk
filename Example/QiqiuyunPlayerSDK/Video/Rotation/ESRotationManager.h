...
@protocol ESRotationManagerDelegate;
@interface ESRotationManager : NSObject

@property (nonatomic, weak, nullable) id<ESRotationManagerDelegate> delegate;

@property (nonatomic, copy, nullable) BOOL(^shouldTriggerRotation)(ESRotationManager *mgr);
...
@property (nonatomic, copy, nullable) UIView *(^targetView)(ESRotationManager *mgr);

@property (nonatomic, copy, nullable) void(^rotationDidStartExeBlock)(ESRotationManager *mgr);
@property (nonatomic, copy, nullable) void(^rotationDidEndExeBlock)(ESRotationManager *mgr);


@end

@protocol ESRotationManagerDelegate <NSObject>
